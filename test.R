...
test_that("testing dataframe with 2 unique values we want to count", {
...
test_that("testing if empty dataframe is given", {
  # "edge cases" test to be added here
})

test_that("check incorrect types", {
  # "error" tests to be added here
  expect_error(count_classes(two_classes_2_obs_as_list, class_labels))
